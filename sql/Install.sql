...
INSERT INTO TRN_LKP_USUARIOS (NOMBRE,APELLIDOS,FECHA_DE_NACIMIENTO,EMAIL,PASSWORD)VALUES("ADMIN","ADMINIS",STR_TO_DATE("19/10/1990",'%d/%m/%Y'),"admin@trn.com",MD5("admin"));
INSERT INTO TRN_LKP_USUARIOS (NOMBRE,APELLIDOS,FECHA_DE_NACIMIENTO,EMAIL,PASSWORD)VALUES("Jose Francisco","López Gil",STR_TO_DATE("19/10/1990",'%d/%m/%Y'),"josefranciscolopezgil@gmail.com",MD5("trn2016"));
INSERT INTO TRN_LKP_USUARIOS (NOMBRE,APELLIDOS,FECHA_DE_NACIMIENTO,EMAIL,PASSWORD)VALUES("Prueba1","Prueba1",STR_TO_DATE("19/10/1990",'%d/%m/%Y'),"Prueba1@trn.com",MD5("trn2016"));

/*TRN_LKP_ROLES_SEGURIDAD
Descripción: Tabla que almacena la configuración de los roles de seguridad.

CREATE TABLE TRN_WEB_ROLES_SEGURIDAD(
...
INSERT INTO TRN_LKP_OBJETIVOS (ID_USER,FECHA_INICIO,PROGRESO,PESO_OBJETIVO,PESO_ACTUAL,OBSERVACIONES) VALUES (3,STR_TO_DATE("26/09/2016",'%d/%m/%Y'),10.5,77.5,88.5,"Cuidado con la hidratación.");
