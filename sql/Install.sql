...
ID_PADRE				INT				,
BOL_ABSTRACTA			TINYINT			NOT NULL DEFAULT 0,
FOREIGN KEY (ID_PADRE) REFERENCES TRN_LKP_TIPO_ALIMENTOS (ID_TIPO_ALIMENTO)
);
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Leche y Derivados",1); 			  /*1*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Huevos",0);						  /*2*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Carnes",0);                         /*3*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Pescados",1);                       /*4*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Legumbres",0);                      /*5*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Frutos Secos",0);                   /*6*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Verduras",1);                       /*7*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Frutas",0);                         /*8*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Cereales",0);                       /*9*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Azúcares y Derivados",0);           /*10*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(1,"Aceites y Grasas",1);               /*11*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Leches",1,0);              /*12*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Quesos",1,0);              /*13*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Yogures",1,0);             /*14*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Carne Roja",3,0);          /*15*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Carne Blanca",3,0);        /*16*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Pescado Blanco",4,0);      /*17*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Pescado Azul",4,0);        /*18*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Marisco",4,0);             /*19*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Tubérculos",7,0);          /*20*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Hortalizas",7,0);          /*21*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Grasas Animales",11,0);    /*22*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,ID_PADRE,BOL_ABSTRACTA)VALUES(2,"Grasas Vegetales",11,0);   /*23*/
INSERT INTO TRN_LKP_TIPO_ALIMENTOS(ID_TIPO_ALIMENTO,NIVEL_JERARQUIA,DESC_TIPO_ALIMENTO,BOL_ABSTRACTA)VALUES(0,0,"RAIZ",1);
UPDATE TRN_LKP_TIPO_ALIMENTOS SET ID_TIPO_ALIMENTO=0 WHERE DESC_TIPO_ALIMENTO="RAIZ";
UPDATE TRN_LKP_TIPO_ALIMENTOS SET ID_PADRE=0 WHERE NIVEL_JERARQUIA=1;
